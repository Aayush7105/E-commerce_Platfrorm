    ...
    <header className="motion-header sticky top-0 z-40 border-b border-white/10 bg-black/95 backdrop-blur">
      <div className="mx-auto flex h-20 w-full max-w-[1440px] items-center justify-between gap-3 px-4 sm:px-8">
        ...
        <div className="flex items-center gap-3">
          {showSearch ? (
            <label className="relative block">
              ...
              <input
                ...
                className="w-32 rounded-xl border border-white/10 bg-zinc-900/90 py-2.5 pl-9 pr-3 text-[0.88rem] text-white outline-none transition placeholder:text-zinc-500 focus:scale-[1.02] focus:border-white/40 sm:w-48 lg:w-64"
              />
            </label>
          ) : (
            <Link
              ...
              className="motion-icon-button rounded-md p-2 text-zinc-300 hover:bg-white/10 hover:text-white"
            >
          ...
          <button
            type="button"
            className="motion-button relative flex items-center gap-2 rounded-xl bg-white px-4 py-2.5 text-black"
          >
